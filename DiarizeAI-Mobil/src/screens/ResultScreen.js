  ...
  const performExport = async (format) => {
      ...
      try {
          if (format === 'pdf') {
                ...
                let htmlContent = `
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .full-page-wrapper { background-color: ${bgColor}; color: ${textColor}; width: 100%; min-height: 100vh; padding: 40px; box-sizing: border-box; }
                            .container { background-color: ${containerBg}; padding: 20px; border-radius: 8px; border: ${containerBorder}; }
                    ...
                    <body>
                        <div class="full-page-wrapper">
                            <div class="container">
                                ...
                                <div class="footer">Generated by DiarizeAI - ${new Date().toLocaleString()}</div>
                            </div>
                        </div>
                    </body>
                    </html>
                ...
                const { uri } = await Print.printToFileAsync({ html: htmlContent, margins: { top: 0, bottom: 0, left: 0, right: 0 } });
              ...
              await Sharing.shareAsync(fileUri, { 
                  UTIType: 'com.microsoft.powerpoint.ppt', 
